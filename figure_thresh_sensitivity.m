...
for sigma=sig_seq
    ...
    for T=T_seq
        for b=1:B
            ...
            c_id = 1;
            for c=c_seq
                [G_hat,grp,grp_effects] = pwd_pureGFE(Y,c*T^(-kappa));
...
function thresh_plot(data,feature,ylab,c_seq,yl,yu)
    ...
    title('$(G^0,N,T)=(2,120,11)$','Interpreter','latex')
    nexttile
    ...
    xlabel('$c$','Interpreter','latex') 
    ylabel(ylab,'Interpreter','latex') 
    title('$(G^0,N,T)=(2,120,66)$','Interpreter','latex')
    nexttile
    ...
    xlabel('$c$','Interpreter','latex') 
    ylabel(ylab,'Interpreter','latex') 
    title('$(G^0,N,T)=(2,120,120)$','Interpreter','latex')
    nexttile
    ...
    xlabel('$c$','Interpreter','latex') 
    ylabel(ylab,'Interpreter','latex') 
    title('$(G^0,N,T)=(3,120,11)$','Interpreter','latex')
    nexttile
    ...
    xlabel('$c$','Interpreter','latex') 
    ylabel(ylab,'Interpreter','latex') 
    title('$(G^0,N,T)=(3,120,66)$','Interpreter','latex')
    nexttile
    ...
    xlabel('$c$','Interpreter','latex') 
    ylabel(ylab,'Interpreter','latex') 
    title('$(G^0,N,T)=(3,120,120)$','Interpreter','latex')
    nexttile
    ...
    xlabel('$c$','Interpreter','latex') 
    ylabel(ylab, 'Interpreter','latex') 
    title('$(G^0,N,T)=(4,120,11)$','Interpreter','latex')
    nexttile
    ...
    xlabel('$c$','Interpreter','latex') 
    ylabel(ylab,'Interpreter','latex') 
    title('$(G^0,N,T)=(4,120,66)$','Interpreter','latex')
    nexttile
    ...
    xlabel('$c$','Interpreter','latex') 
    ylabel(ylab,'Interpreter','latex') 
    title('$(G^0,N,T)=(4,120,120)$','Interpreter','latex')
